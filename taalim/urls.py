...
urlpatterns = [
    ...
    path("dashboard_teacher/<int:pk>/grade_course/", views.grade_course, name="grade_course"),
    ...
    path("dashboard_teacher/<int:pk>/enroll/<int:id>", views.enroll, name="enroll"),
    path("dashboard_teacher/<int:pk>/unroll/<int:id>", views.unroll, name="unroll"),
    ...
    path("dashboard_admin/<int:pk>/assign_gpa", views.assign_gpa, name="assign_gpa"),
    ...
    path("dashboard_teacher/<int:pk>/semester/edit/<int:id>", views.edit_semester, name="edit_semester"),
    path("dashboard_teacher/<int:pk>/semester/delete/<int:id>", views.delete_semester, name="delete_semester"),
